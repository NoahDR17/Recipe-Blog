...
class AddRecipe(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        """ Sets the author to the
        logged-in user and displays a success message """
...
class RecipeListView(ListView):
    ...
    with optional meal type filtering, default is set to view all """
    model = Recipe
...
class RecipeDeleteView(LoginRequiredMixin, DeleteView, UserPassesTestMixin):
    ...
    def get_success_url(self):
        ...
        to the recipe list after deletion """
